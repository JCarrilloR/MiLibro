...
### Corriendo primer ejemplo. Archivos de entrada ASVs_counts.tsv (se agrega "OTU" en primer linea, separado por un tabulador) y archivo ASVs.fa. El current directory debe ser donde están los arhivos .fa y .tsv
...
### Version 2. 
## Se agregaron dos argumentos adicionales: 
# -per_sequence_contrib: Calcula la contribución funcional por cada ASV individual
# --stratified: Genera resultados estratificados por taxón 
...
🔹 1) “There was only one file for the function: EC / KO”
...
👉 “Solo hubo predicciones para un dominio (por ejemplo, solo bacterias)”.
Esto es muy común si:
Tus ASVs son sobre todo bacterianas (16S típico)
O si la base de referencia arqueal no tuvo matches

🔹 2) “All ASVs were below the max NSTI cut-off of 2.0…”
Este mensaje es muy bueno:
PICRUSt2 calcula para cada ASV un valor NSTI (Nearest Sequenced Taxon Index).
Cuanto más bajo, más “cerca” está tu ASV de un genoma de referencia secuenciado.
